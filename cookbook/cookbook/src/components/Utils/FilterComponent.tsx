...
import MultiSelectCheckboxDropdown from "./MulltiSelectCheckboxDropdown";
...
function FilterComponent({setFilters}: IFiltersProps) {
    ...
    return (
        <div  className={"bg-cook text-cook-light p-2 pb-14 md:pb-2 sticky top-10 md:top-0 z-50 md:z-0 h-screen overflow-auto"}>
